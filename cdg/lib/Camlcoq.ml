...
let globvar_sizes = (Hashtbl.create 17 : (positive, int32) Hashtbl.t)

let reset_globvar_sizes =
  Hashtbl.reset globvar_sizes

let add_globvar_size id size =
  Hashtbl.add globvar_sizes id size

let get_globvar_size id =
  try Hashtbl.find globvar_sizes id
