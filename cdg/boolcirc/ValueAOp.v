...
(*
  exploit cmove_sound; [apply H1| apply H0| apply H2|].
  destruct a1; try discriminate H. simpl.
  destruct (Val.eq (Vint i) Vfalse).
   inv e.  rewrite Int.eq_true in H; inv H. auto.
  rewrite Int.eq_false in H; inv H; auto.
  intro HH; apply n; unfold Vfalse; f_equal; auto.
  exploit add_sound; [apply H1| |].
  apply (vmatch_i bc i).
  destruct a1; simpl; auto with va.
