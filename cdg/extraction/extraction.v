...
Extract Constant Compopts.optim_constexp =>
  "fun _ -> !Clflags.option_fce".
Extract Constant Compopts.optim_loop_unroll_estimates =>
  "LoopUnroll_estimates.unroll_estimates".
Extract Constant Compopts.optim_loop_unroll_infer_estimates =>
  "!Clflags.option_floop_unroll_infer ".
(*Extract Constant Compiler.print_CminorUnroll => "PrintCminor.print_if_unroll".*)
...
Extract Constant Compiler.print_RTLC => "PrintRTLC.print_if".
Extract Constant Compiler.print_ValCirc => "PrintValCirc.print_if".
Extract Constant Compiler.print_HLC => "PrintHLCirc.print_if".
