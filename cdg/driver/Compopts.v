...
(** Flag -ce. For constant expansion in RTLC. *)
Parameter optim_constexp: unit -> bool.

(** Flag -funroll-loop.  For loop-unrolling in CMinor. *)
Require BinPos.
Require CminorSel.
Parameter optim_loop_unroll_estimates: CminorSel.stmt -> BinPos.positive -> nat.
Parameter optim_loop_unroll_infer_estimates: bool.
