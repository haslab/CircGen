...
// 50 x 32 bits = 1600 bits for each party
...
unsigned int INPUT_A_a1;
unsigned int INPUT_A_a2;
unsigned int INPUT_A_a3;
unsigned int INPUT_A_a4;
unsigned int INPUT_A_a5;
unsigned int INPUT_A_a6;
unsigned int INPUT_A_a7;
unsigned int INPUT_A_a8;
unsigned int INPUT_A_a9;
unsigned int INPUT_A_a10;
unsigned int INPUT_A_a11;
unsigned int INPUT_A_a12;
unsigned int INPUT_A_a13;
unsigned int INPUT_A_a14;
unsigned int INPUT_A_a15;
unsigned int INPUT_A_a16;
unsigned int INPUT_A_a17;
unsigned int INPUT_A_a18;
unsigned int INPUT_A_a19;
unsigned int INPUT_A_a20;
unsigned int INPUT_A_a21;
unsigned int INPUT_A_a22;
unsigned int INPUT_A_a23;
unsigned int INPUT_A_a24;
unsigned int INPUT_A_a25;
...
unsigned int INPUT_B_a1;
unsigned int INPUT_B_a2;
unsigned int INPUT_B_a3;
unsigned int INPUT_B_a4;
unsigned int INPUT_B_a5;
unsigned int INPUT_B_a6;
unsigned int INPUT_B_a7;
unsigned int INPUT_B_a8;
unsigned int INPUT_B_a9;
unsigned int INPUT_B_a10;
unsigned int INPUT_B_a11;
unsigned int INPUT_B_a12;
unsigned int INPUT_B_a13;
unsigned int INPUT_B_a14;
unsigned int INPUT_B_a15;
unsigned int INPUT_B_a16;
unsigned int INPUT_B_a17;
unsigned int INPUT_B_a18;
unsigned int INPUT_B_a19;
unsigned int INPUT_B_a20;
unsigned int INPUT_B_a21;
unsigned int INPUT_B_a22;
unsigned int INPUT_B_a23;
unsigned int INPUT_B_a24;
unsigned int INPUT_B_a25;
int OUTPUTw;
...
int main(){
  ...
  AddInput(INPUT_B_a8);
  AddInput(INPUT_B_a9);
  AddInput(INPUT_B_a10);
  AddInput(INPUT_B_a11);
  AddInput(INPUT_B_a12);
  AddInput(INPUT_B_a13);
  AddInput(INPUT_B_a14);
  AddInput(INPUT_B_a15);
  AddInput(INPUT_B_a16);
  AddInput(INPUT_B_a17);
  AddInput(INPUT_B_a18);
  AddInput(INPUT_B_a19);
  AddInput(INPUT_B_a20);
  AddInput(INPUT_B_a21);
  AddInput(INPUT_B_a22);
  AddInput(INPUT_B_a23);
  AddInput(INPUT_B_a24);
  AddInput(INPUT_B_a25);
  BeginCirc();
  ...
  int a = popcount_2(INPUT_B_v^INPUT_A_v) 
    ...
    + popcount_2(INPUT_A_a1^INPUT_B_a1)
    + popcount_2(INPUT_A_a2^INPUT_B_a2)
    + popcount_2(INPUT_A_a3^INPUT_B_a3)
    + popcount_2(INPUT_A_a4^INPUT_B_a4)
    + popcount_2(INPUT_A_a5^INPUT_B_a5)
    + popcount_2(INPUT_A_a6^INPUT_B_a6)
    + popcount_2(INPUT_A_a7^INPUT_B_a7)
    + popcount_2(INPUT_A_a8^INPUT_B_a8)
    + popcount_2(INPUT_A_a9^INPUT_B_a9)
    + popcount_2(INPUT_A_a10^INPUT_B_a10)
    + popcount_2(INPUT_A_a11^INPUT_B_a11)
    + popcount_2(INPUT_A_a12^INPUT_B_a12)
    + popcount_2(INPUT_A_a13^INPUT_B_a13)
    + popcount_2(INPUT_A_a14^INPUT_B_a14)
    + popcount_2(INPUT_A_a15^INPUT_B_a15)
    + popcount_2(INPUT_A_a16^INPUT_B_a16)
    + popcount_2(INPUT_A_a17^INPUT_B_a17)
    + popcount_2(INPUT_A_a18^INPUT_B_a18)
    + popcount_2(INPUT_A_a19^INPUT_B_a19)
    + popcount_2(INPUT_A_a20^INPUT_B_a20)
    + popcount_2(INPUT_A_a21^INPUT_B_a21)
    + popcount_2(INPUT_A_a22^INPUT_B_a22)
    + popcount_2(INPUT_A_a23^INPUT_B_a23)
    + popcount_2(INPUT_A_a24^INPUT_B_a24)
    + popcount_2(INPUT_A_a25^INPUT_B_a25)
    ;
